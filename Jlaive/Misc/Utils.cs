...
namespace Jlaive
{
    ...
    public class Utils
    {
        ...
        public static (CompilerResults, byte[]) CompileCS(string source, string[] references, string[] embedfiles, string compileroptions)
        {
            ...
            foreach (string f in embedfiles) parameters.EmbeddedResources.Add(f);
