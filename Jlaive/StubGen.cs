...
namespace Jlaive
{
    public class StubGen
    {
        ...
        {
            string namespacename = RandomString(6, rng);
            string classname = RandomString(6, rng);
            string functionname = RandomString(6, rng);
            string functionname2 = RandomString(6, rng);
...
namespace " + namespacename + @"
{
    internal class " + classname + @"
    {
        ...
        delegate bool CheckRemoteDebuggerPresent(IntPtr hProcess, ref bool isDebuggerPresent);
...
CheckRemoteDebuggerPresent CheckRemoteDebuggerPresent = (CheckRemoteDebuggerPresent)Marshal.GetDelegateForFunctionPointer(crdpaddr, typeof(CheckRemoteDebuggerPresent));
